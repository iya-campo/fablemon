...
import { ArrowBack, BusinessCenter, CatchingPokemon, DirectionsRun, Loop, MedicationLiquid, MoreVert, SportsMma } from '@mui/icons-material'
import { Box, Button, Chip, Grid, IconButton, List, ListItemButton, ListItemIcon, ListItemText, Menu, MenuItem, Modal, Paper, SelectChangeEvent, Stack, Typography } from '@mui/material'
import Image from 'next/image'
import React, { useEffect, useState } from 'react'
import EncounterActions from '../../components/EncounterActions'

const WildBattle = ({ battleStart, handleEndBattle }: any) => {
